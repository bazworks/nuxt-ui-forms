...
// Card layout schema
const cardSchema = computed<DetailSchema>(() => ({
  item,
  layout: "card",
  showHeader: true,
...
<template>
  <div class="max-w-7xl mx-auto p-6">
    <div class="mb-8">
      <h1 class="text-3xl font-bold text-gray-900 mb-2">Card Layout Demo</h1>
      <p class="text-gray-600">
        Each section displayed as a separate card - perfect for dashboard-style
        detail views
      </p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
      <SchemaDetail :schema="cardSchema" @action="handleAction">
        <!-- Custom skills field -->
