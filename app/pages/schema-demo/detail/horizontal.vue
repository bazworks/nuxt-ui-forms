...
const horizontalSchema = computed<DetailSchema>(() => ({
  item,
  layout: "horizontal",
  showHeader: true,
  ...
  <div class="max-w-6xl mx-auto p-6">
    <div class="mb-8">
      ...
      <p class="text-gray-600">
        Fields arranged in a grid layout within sections for efficient space
        usage
      </p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
      <SchemaDetail :schema="horizontalSchema" @action="handleAction">
        <!-- Custom skills field -->
