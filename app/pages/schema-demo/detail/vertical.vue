...
// Vertical layout schema
const verticalSchema = computed<DetailSchema>(() => ({
  item,
  layout: "vertical",
  showHeader: true,
  ...
  <div class="max-w-4xl mx-auto p-6">
    <div class="mb-8">
      ...
      <p class="text-gray-600">
        All fields stacked vertically in organized sections
      </p>
    </div>

    <!-- Vertical Layout Demo -->
    <div class="bg-white rounded-lg shadow-lg p-6">
      <SchemaDetail :schema="verticalSchema" @action="handleAction">
        <!-- Custom skills field -->
