...
// Mixed layout configuration - complex nested layout
const uiSchema = {
  layout: {
    type: "vertical",
    fields: [
...
<template>
  <div class="max-w-4xl mx-auto p-6">
    <div class="mb-6">
      <h1 class="text-3xl font-bold text-gray-900 mb-2">Mixed Layout Demo</h1>
      <p class="text-gray-600">
        Complex layout combining horizontal, vertical, and grouping
      </p>
    </div>

    <div class="bg-white rounded-lg shadow-lg p-8">
      <!-- The form with mixed layout -->
